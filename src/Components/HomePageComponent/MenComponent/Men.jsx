...
function Men(props){
    ...
    const mensClothing = props.products.filter(element => element.tags[1] === "men's shirts");
    const mensShoes = props.products.filter(element => element.tags[0] === "footwear");

    const total = [...mensClothing, ...mensShoes];
    ...
    return(
        <div className={Style.container}>
                    <h2 className={Style.nameContainer}>MEN</h2>
